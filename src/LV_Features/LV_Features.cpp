/**
 * \file LV_Features.cpp
 * \brief Implementation various method for calculating shape descriptors
 * \author PB
 * \date 2015/02/03
 * \todo Clean this code from Containers and move definitions to *.h
 */
